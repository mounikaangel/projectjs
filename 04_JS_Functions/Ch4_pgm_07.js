...
var number1 = 150;  // Changed value
var number2 = 75;   // Changed value
var number3 = 25;   // Added new variable
var result;
var findTotal;

findTotal = function () {
    result = number1 + number2 + number3;  // Updated to add three numbers
};

findTotal();

console.log(number1 + " + " + number2 + " + " + number3 + " = " + result);  // Updated to show new calculation
