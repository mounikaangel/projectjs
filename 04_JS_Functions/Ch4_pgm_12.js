...
sale4 = { price: 75, taxRate: 12 };  // Added sale object

// Array to hold all sale objects
var sales = [sale1, sale2, sale3, sale4];

// Define the calculateTax function
calculateTax = function (sale) {
    sale.tax = sale.price * sale.taxRate / 100;
    sale.total = sale.price + sale.tax;
};

// Define the displaySale function
...
// Loop through all sales and apply the functions
